# openbackdoors的evaluator部分，整个源码，攻击和防御的可读性高，可以借鉴。
# openbackdoor/utils/evaluator.py
# 地址:https://github.com/thunlp/OpenBackdoor/blob/main/openbackdoor/utils/evaluator.py
